      ...
      <section class="row">
         <div class="col-3">
            <button  value="" style="background-color: #2c4d6c6e;
               border: 1px solid #2c4d6c6e;width: 70%;padding: 10px;margin-top: 30px;margin-left:60px;" id="ficherolocal">
               Fichero local  
               <p>Los ficheros no pueden superar los <?php echo ini_get(
                  "upload_max_filesize"
                  ); ?></p>
            </button>
            <button value="" style="background-color: #2c4d6c6e;
               border: 1px solid #2c4d6c6e;width: 70%;padding: 10px;margin-top: 30px;margin-left:60px;" id="ficheroexterno">Fichero externo </button>
         </div>
         <div class="col-6">
         ...
         <?php
            ...
            if (isset($_FILES["url_song_local"]) || isset($_FILES["url_img_local"])) {
                ...
                $url_canciones =
                    "../songsfileslocal/" . $_FILES["url_song_local"]["name"];
