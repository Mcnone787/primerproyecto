   ...
   <body id="back1">
      ...
      <div style="">
         ...
         <div style="overflow: auto;height: 200px; width: 60%; margin-top: 20px;margin:0 auto;/* width */::-webkit-scrollbar {
            ...
            <?php if (isset($_COOKIE["canciones"])) {
               ...
               if (count($cookie_main["titulo_cancion"]) > 0) {
                   array_multisort(
                       ...
                       SORT_DESC,
                       $cookie_main["srcimg"],
                       $cookie_main["titulo_cancion"]
                   );
                   echo "<div style=''>
               <div style='display:flex;'>
               <img src='" .
                       $cookie_main["srcimg"][0] .
                       "' alt='cancionimg' height='90px' width='auto'>
               <h4>Puesto numero 1</h4>
               <div style='display: flex;
               flex-direction: column;
               justify-content: center;'>
               <p >Nombre de la cancion: " .
                       $cookie_main["titulo_cancion"][0] .
                       " </p>
               <p>Has reproducido la cancion " .
                       $cookie_main["click"][0] .
                       " veces</p>
               </div>
               </div>
         ...
         <div style="">
            ...
            <div style="    display: flex;
               ...
               <div style="padding:20px;border-right:solid;width:50%;">
                  ...
                  <?php if (isset($_COOKIE["Playlists_lista_"])) {
                     $UltimaPlaylistsEscojida = json_decode(
                         $_COOKIE["Playlists_lista_"],
                         true
                     );
                     ...
                     if (isset($_GET["ordenado"])) {
                         switch ($_GET["ordenado"]) {
                             case "escuchadas":
                                 array_multisort(
                                     $UltimaPlaylistsEscojida["clicks"],
                                     SORT_DESC,
                                     $UltimaPlaylistsEscojida["playlist"]
                                 );
                     ...
                     for (
                         $i = 0;
                         $i < count($UltimaPlaylistsEscojida["playlist"]);
                         $i++
                     ) {
                         echo "<p style='text-align:center;margin-top:10px;'>" .
                             $UltimaPlaylistsEscojida["playlist"][$i] .
                             " </p>";
                     }
                     echo "
                               </div>
                     ...
                     for (
                         ...
                         echo "                                <p style='text-align:center;margin-top:10px;'>" .
                             $UltimaPlaylistsEscojida["clicks"][$i] .
                             " </p>
                                 ";
                     }
                     echo "
               ...
               <div style="padding:20px;width:50%;">
                  <?php if (isset($_COOKIE["Playlists"])) {
                     $UltimaPlaylistsEscojida = json_decode(
                         $_COOKIE["Playlists"],
                         true
                     );
                     ...
                     justify-content: center; margin-top:10px;'>
                             ...
                             $UltimaPlaylistsEscojida["playlist"][0] .
                             " </p>
                                 </div>
                                 <div style='display: flex;
                                 flex-direction: column;
                                 ...
                                 <p style='margin-left:10px;text-align:center;'>Ultima vez escuchada </p>
                                       <p style='text-align:center;margin-top:10px;'>" .
                             $UltimaPlaylistsEscojida["fecha"][0] .
                             " </p>
                                 </div>
                                 </div>  
