...
let btnaudio=document.getElementById("volumen_icon")
var audio = new Audio();
let interval_main
let cancion_index = 0
...
//funcion que permite ir haciendo avanzar la barra
function barra() {
...
//funcion para calcular lo tiempos del audio
...
//evento de ventana para poder saber que tecla a sido pulsada y poder avanzar,retroceder y pausar el audio
...
//Funcion para subir y bajar el volumen del audio
volumen.addEventListener("click",()=>{
    let value_main=volumen.value/100
    audio.volume=value_main
})
